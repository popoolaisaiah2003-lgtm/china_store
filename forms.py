...
class ReviewForm(FlaskForm):
    ...
    rating = SelectField('Rating *', coerce=int, choices=[(5, '5 Stars - Excellent'), (4, '4 Stars - Very Good'), (3, '3 Stars - Good'), (2, '2 Stars - Fair'), (1, '1 Star - Poor')], validators=[Optional()], default=5)
